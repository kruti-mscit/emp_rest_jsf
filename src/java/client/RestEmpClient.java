 ...
 * USAGE:
 * <pre>
 *        RestEmpClient client = new RestEmpClient();
...
public class RestEmpClient {
    ...
    public void updateEmployee(String empId, String fname, String lname, String age, String salary, String deptId) throws ClientErrorException {
        webTarget.path(java.text.MessageFormat.format("updateEmployee/{0}/{1}/{2}/{3}/{4}/{5}", new Object[]{empId, fname, lname, age, salary, deptId})).request().put(null);
    }
